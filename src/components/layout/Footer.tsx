        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          ...
          <div className="text-center md:flex flex-col items-center md:px-4 py-4">
            ...
            <div className="flex flex-col gap-5 items-center">
              ...
              <a href="https://discord.com/users/th0rner" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors flex items-center gap-3">
